			...
			<div class="mid">
				<div class="mid_emial">
					...
					<form class="email">
						...
						<span>验证码</span><img title="点击图片更换验证码" onclick="changeCheckCode()" src="<%=path %>/CheckCodeServlet" title="点击更换验证码"/><input id="checkcode" class="checkcode" type="text" name="checkcode"><br>
					</form>
